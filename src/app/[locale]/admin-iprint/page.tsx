    ...
    <div className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-800">
          ...
          <button className="bg-brand-blue text-white px-6 py-3 rounded-xl font-bold hover:bg-opacity-90 transition-all">{t("openGalleryManager")}</button>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-800">
          ...
          <button className="bg-brand-blue text-white px-6 py-3 rounded-xl font-bold hover:bg-opacity-90 transition-all">{t("openServicesManager")}</button>
        </div>
      </div>
    </div>
  );
